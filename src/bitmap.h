 ...
 *                     */ 
extern unsigned long _find_first_bit_le(const unsigned long *addr, unsigned long size);
extern unsigned long _find_first_zero_bit(const unsigned long *addr, unsigned long size);
extern unsigned long _find_next_zero_bit_le(const void *addr, unsigned long size, unsigned long offset);
extern unsigned long _find_next_bit_le(const void *addr, unsigned long size, unsigned long offset);
...
extern unsigned long find_next_zero_bit_le(const void *addr, unsigned long size, unsigned long offset);
extern unsigned long find_next_bit_le(const void *addr, unsigned long size, unsigned long offset);
...
#define BITMAP_FIRST_WORD_MASK(start) (~0UL << ((start) % __BITS_PER_LONG))
...
#define BITS_TO_LONGS(n) ((n + __BITS_PER_LONG - 1) / __BITS_PER_LONG)
