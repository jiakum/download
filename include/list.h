...
/*
 * Insert a newlist entry between two known consecutive entries.
 *
...
/**
 * list_add - add a newlist entry
 * @newlist: newlist entry to be added
 * @head: list head to add it after
 *
 * Insert a newlist entry after the specified head.
...
/**
 * list_add_tail - add a newlist entry
 * @newlist: newlist entry to be added
 * @head: list head to add it before
 *
 * Insert a newlist entry before the specified head.
...
/**
 * list_replace - replace old entry by newlist one
 * @old : the element to be replaced
 * @newlist : the newlist element to insert
 *
...
{
    struct list_head *newlist_first = entry->next;
	list->next = head->next;
	list->next->prev = list;
	list->prev = entry;
	entry->next = list;
